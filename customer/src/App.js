...
function Login(props) {
    ...
    const onLogin = () => {
        axios.post('/staff/login', { loginEmail: loginEmail, password: password }).then(response => {
            console.log(props);
            ...
            <Modal.Body>
                <Form>
                    <Form.Group controlId="formBasicEmail">
                        <Form.Control type="loginEmail" placeholder="Email"
    ...
    return (
        <>
            <div style={{ textAlign: "center", width: '50%', margin: 'auto', marginTop: '10%' }}>
                <Modal aria-labelledby="contained-modal-title-vcenter"
                    centered show={show} onHide={handleClose} style={{ marginTup: '2vh' }}>
                    {customerModal}
                ...
                <div style={{ textAlign: "center" }}>
                    <br /><br />
                    <Button style={{ width: '40%' }} variant="danger" onClick={handleShow}>Sign in </Button>
                    <br /><br />
                    <a href='https://www.hsbc.com.au/'>
                        <p style={{ color: 'red' }}>More about HSBC</p></a>
                </div>
